...
int main() {
    ...
    // The assignment suggests testing with various sizes (e.g., from 1K to 1M). Here for demonstration, we use 1000.
    int n = 1000;
    int iterations = 10;  // Run each test at least 10 times to compute the average.
    ...
    // Run experiments using heap sort.
